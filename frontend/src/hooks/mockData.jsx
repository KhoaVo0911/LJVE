...
export const journalData = [
  ...
  },
  {
    ...
    description: "Behind-The-Scene of my first Commercial job as a DOP. How did we manage to shoot in the middle of the sunny day. How to plan up with only 3 days prep.",
  ...
  },
  {
    ...
    description: "The story about my first short film after coming back to Vietnam. 3 days shooting nonstop, alot of sleepless night and the project make me improve alot.",
    imageTitle: "assets/IMG_3556.jpg",
    imageList: ["assets/IMG_3556.jpg"],
    information: ["Observing movement, shadows, and colors in Saigon."],
  },
  ...
  },
  {
    ...
    description: "Behind-The-Scene of my first short film as a DOP. The story about how me and my crew can be managed to finish within 2 weeks for a whole production process.",
    imageTitle: "assets/IMG_3556.jpg",
    imageList: ["assets/IMG_3556.jpg"],
    information: ["Observing movement, shadows, and colors in Saigon."],
  },
