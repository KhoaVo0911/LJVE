    ...
    <div>
      <div className="flex flex-col md:flex-row items-start md:items-start">
        <div className="flex flex-col items-center md:items-start space-y-8 w-full md:w-1/2 md:pr-12">
          <div>
            <div className="text-3xl sm:text-4xl md:text-5xl font-[Neogrotesk-AltBold] text-center md:text-left">
              ABOUT ME
            </div>
          </div>
          <div className="flex-1 w-full">
            <div className="text-base sm:text-lg md:text-[14px] font-[BeauSans] leading-relaxed max-w-full md:max-w-[210vh] whitespace-pre-line break-words hyphens-none md:mr-30 px-2 md:px-0 text-justify">
          ...
          <div className="flex items-center space-x-2 text-base sm:text-lg md:text-[14px]">
