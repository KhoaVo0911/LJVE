...
const FilmDetails = () => {
  ...
  return (
    <div className="bg-black min-h-screen w-full font-[beauSans] relative pt-16 pb-24 px-4">
      {/* Left: Credit */}
      <div className="absolute left-0 top-32 w-[380px] pl-8 z-10">
        <h1 className="text-5xl font-bold mb-2 tracking-normal text-white">
          {film.name}
        </h1>
        <div className="text-white text-base font-normal mb-1">
          {filmTitle}
          {/* {film.genre} */}
        </div>
        ...
        <div className="space-y-4">
          {film.credit.map((section, idx) => (
            <div key={idx} className="mb-2">
              <div className="uppercase text-white text-[20px] mt-6 mb-1 font-normal">
                {section.section}
              </div>
              <div>
                    ...
                    <div key={i} className="mb-1">
                      {item.label ? (
                        ...
                        <div
                          className={
                            item.italic
                              ? "italic text-white text-[20px] font-light"
                              : "text-white text-[20px] font-light"
                          }
                        >
                          {item.names.join(", ")}
                        </div>
